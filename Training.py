...
spark = SparkSession \
    .builder \
    .appName("CS643_WineQualityPredictionsML") \
    .getOrCreate()

## Load Training Dataset
train_df = spark.read.format('csv').options(header='true', inferSchema='true', sep=';').load('s3://cs643finalproject/TrainingDataset.csv')
validation_df = spark.read.format('csv').options(header='true', inferSchema='true', sep=';').load('s3://cs643finalproject/ValidationDataset.csv')
